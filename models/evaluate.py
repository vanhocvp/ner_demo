...
class NerDataset(Dataset):
    ...
    def read_data(self, filepath):
        ...
        if self.vocab is None or self.label is None:
            self.vocab = torchtext.vocab.Vocab(Counter(all_words), specials=(PAD, UNK, BOS, EOS), specials_first=False)
            self.label = torchtext.vocab.Vocab(Counter(all_ners), specials=(BOS, EOS, PAD), specials_first=False)
